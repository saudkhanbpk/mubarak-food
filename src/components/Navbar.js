      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-1 xl:space-x-2">
            ...
            <Link
              href="/cart"
              className="ml-4 inline-flex items-center px-5 py-2.5 xl:px-6 xl:py-3 rounded-full bg-gradient-to-r from-orange-400 to-red-500 text-white font-semibold hover:from-orange-500 hover:to-red-600 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg text-sm xl:text-base group"
            >
              <span>Cart</span>
              <ShoppingCart className="ml-2 h-4 w-4 xl:h-5 xl:w-5 group-hover:animate-bounce" />
            </Link>
          </div>
        ...
        >
          <div className="px-2 pt-2 pb-4 space-y-2 bg-gradient-to-b from-white to-orange-50/30 border-t border-gray-100 rounded-b-2xl shadow-inner">
            ...
            <Link
              href="/cart"
              className="flex items-center justify-center space-x-2 mx-2 mt-4 px-6 py-3 rounded-xl bg-gradient-to-r from-orange-400 to-red-500 text-white font-semibold text-base sm:text-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-200"
              onClick={() => setIsMenuOpen(false)}
            >
